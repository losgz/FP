...
def location(url, latitude, longitude, radius, categories):
    dic = f"?categories={categories}&filter=circle:{longitude},{latitude},{radius}&limit=50&apiKey=ac1fbe548edb4eb2bf8f5642519ac399"
...
def main():
    ...
    try:
        ...
        with open("P6G01/Projeto02/categories.txt", "r") as f:
            for line in f:
                print(line.strip())
